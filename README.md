...
[Comment the issue to tell us](https://github.com/wowucco/go-admin/issues/71).
...
More framework examples: [https://github.com/wowucco/go-admin/tree/master/examples](https://github.com/wowucco/go-admin/tree/master/examples)
